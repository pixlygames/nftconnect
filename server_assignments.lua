...
Citizen.CreateThread(function()
    ...
    if not PropertiesTable then
        ...
        TriggerEvent('ps-housing:server:requestProperties') -- Assumes ps-housing listens for this
    end
end)
...
local function GeneratePlate()
    ...
    local plate = "NFT" .. math.random(1000, 9999) -- Example: NFT1234
    ...
    MySQL.Async.execute([[
        ...
        if rowsChanged > 0 then
            ...
            if exports['qb-vehiclekeys'] then
                 ...
                 -- Trigger client events if needed (GiveKeys might handle this)
